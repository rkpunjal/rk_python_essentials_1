...
print("contains_pickle('red', 45, 'pickle', []) : ", contains_pickle('red', 45, 'pickle', []))
print("contains_pickle(1, 2, 'blue') : ", contains_pickle(1, 2, 'blue'))
...
print("count_fails(99,48,79,36) : ", count_fails(99, 48, 79, 36))
print("count_fails(85,78,91) : ", count_fails(85, 78, 91))
print("count_fails(50,41,47,74,76,81) : ", count_fails(50, 41, 47, 74, 76, 81))
...
print("get_top_students(tim=91, stacy=83, carlos=97, jim=69) : ", get_top_students(tim=91, stacy=83, carlos=97, jim=69))
print("get_top_students(colt=61, elton=76) : ", get_top_students(colt=61, elton=76))
print("get_top_students(kitty=80, blue=95, toad=91) : ", get_top_students(kitty=80, blue=95, toad=91))
